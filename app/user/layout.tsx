...
import { CartProvider, useCart } from "@/app/components/CartContext";
...
function UserLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen bg-stone-50 flex overflow-hidden">
      ...
      >
        <AdminSidebar isOpen={isSidebarOpen} onToggle={() => setIsSidebarOpen((prev) => !prev)} cartCount={totalItems} />
      </div>
